...
Cluster    : UAI (SLURM), 40 simultaneous jobs, 10 min / 4 GB each
Date       : 05-05-2026
"""
...
# ---------------------------------------------------------------------------
# Custom UAI SLURM environment: max 40 concurrent
# ---------------------------------------------------------------------------
class UAISlurmEnvironment(SlurmEnvironment):
    MAX_TASKS = 1000  # cluster MaxArraySize=1001
...
# ---------------------------------------------------------------------------
# Suite: IPC 2014 & 2018 optimal-track domains
# ---------------------------------------------------------------------------
DOMAINS = [
    "barman-opt14-strips",
    "cavediving-14-adl",
...
# ---------------------------------------------------------------------------
# Environment: UAI cluster, 40 simultaneous jobs, 10 min / 4 GB each
# ---------------------------------------------------------------------------
ENV = UAISlurmEnvironment(
    partition="compute-slim",
    memory_per_cpu="4G",
    time_limit_per_task="1:10:00",   # 6 runs x 10min + overhead
)
...
# ---------------------------------------------------------------------------
# Algorithm configurations (w = 1.5, 2.0, 3.0)
# ---------------------------------------------------------------------------
CONFIGS = [
    # ── w = 1.5 ──────────────────────────────────────────────────────────
    (
