...
class StrategyInstant : public PrioritiesStrategy {
    public:
        ...
        int compute_heuristic_from_priority(double heuristic_priority) override;  /// IMPLEMENTAR ESTA FUNCION QUE HACE LA NORMALIZACION ES DECIR MULTIPLICA POR UNA AMPLIFICACION
};
}